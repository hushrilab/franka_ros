...
//  // Point to Point movements
  ...
  double motion_damp = 0.008;   /*((position_d_target - position_init).norm() - (position_d_target - curr_position).norm()); */  // or just motion damp = 0.0008;
